...
class AusmashAPISettings(BaseSettings):
	...
	#TODO: Different cache timeouts for different URL prefixes, /elo should be days=7 and /games and /regions should be a long time (though the latter may have new cities added)
